...
import { HashtagIcon, ClockIcon, EnvelopeIcon, ExclamationTriangleIcon } from '@heroicons/react/24/outline';
...
export function TeamDetailPage(): JSX.Element {
  ...
  return (
    <div className="px-4 py-8 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-8">
      <PageHeader
        title={team.name}
        subtitle="Team Overview and Ownership"
      />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <ul className="space-y-3">
                {team.activeIncidents.map(incident => (
                  <li key={incident.id}>
                    ...
                    >
                      <div className="font-medium text-slate-200 text-sm mb-1">{incident.title}</div>
        ...
        <div className="lg:col-span-2">
          <div className="flex items-center justify-between mb-4">
            ...
            <Badge color="slate">{team.services.length} total</Badge>
          </div>
